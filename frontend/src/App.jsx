    ...
    <div className="container mx-auto p-4">
      ...
      {activeTab === "bmi" && (
        <section className="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6 mb-10">
          ...
          {bmiResult !== null && (
            <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded">
              <strong className="text-gray-700">Your BMI:</strong> {bmiResult}
            </div>
          )}
        </section>
      )}
        ...
        <section className="max-w-xl mx-auto bg-white shadow-lg rounded-lg p-6 mb-10">
          ...
          {history.length > 0 ? (
            <ul className="space-y-6">
              {history.map((entry, index) => {
                // Assume entry.data is an object; format differently if it's Nutrition Advice.
                ...
                return (
                  <li key={index} className="p-4 border rounded-lg bg-gray-50">
                    ...
                    {entry.type === "Nutrition Advice" && data.advice ? (
                      <div className="prose">
                        <p>
                          <strong>BMI:</strong> {data.bmi}
                        </p>
                        <p>
                          <strong>Issue:</strong> {data.nutritionProblem}
                        </p>
